...
class BSM2_LCA_MPC:
    def __init__(self):
        ...
        self.model.set_rhs('S_NH_4', -0.1 * self.S_NH_4 + 0.01 * self.KLa4)
        self.model.set_rhs('S_NO_4', -0.1 * self.S_NO_4 + 0.001 * self.Q_intr)
        self.model.set_rhs('S_O_4',  -0.5 * self.S_O_4 + 0.1 * self.KLa4)
        self.model.set_rhs('F_to_M', -0.01 * self.F_to_M) 
        ...
        lterm = 1.0 * self.KLa4 + 0.0001 * self.Q_intr 
        mterm = 10.0 * self.S_NH_4 # Penalize high Ammonia
        self.mpc.set_objective(mterm=mterm, lterm=lterm)
        self.mpc.set_rterm(KLa4=0.1, Q_intr=0.1)
